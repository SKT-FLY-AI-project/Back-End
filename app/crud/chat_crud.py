...
async def get_or_create_conversation(
    db: AsyncSession, user_id: str, image_url: str, title: str, artist: str,
    ...
    if not conversation_id:
        result = await db.execute(
            ...
            .where(Conversation.image_url == image_url)
...
# 대화 히스토리 삭제
async def delete_conversation_history(db: AsyncSession, conversation_id: str):
    result = await db.execute(
